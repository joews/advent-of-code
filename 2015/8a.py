...
for line in input.split("\n"):
  if line:
    unescaped = codecs.decode(line, "unicode_escape")
    print line, len(line), len(unescaped) - 2
    result = result + len(line) - len(unescaped) + 2
    #print line, len(line), codecs.decode(line, "unicode_escape")
